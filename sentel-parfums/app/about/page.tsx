...
const values = [
  ...
  },
  {
    ...
    description: 'Né au cœur du Maroc, Olivare Parfums allie les traditions orientales de parfumerie avec les standards internationaux de qualité.',
  },
  {
    icon: Leaf,
  ...
  return (
    <div className="pt-20 lg:pt-24">
        ...
        <div className="relative z-10 section-padding text-center max-w-4xl mx-auto py-20">
          <AnimatedSection>
            ...
            <p className="body-lg text-lg max-w-2xl mx-auto">
              Olivare Parfums est né d&apos;une conviction simple : le luxe olfactif ne devrait pas être
        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-16">
            ...
            <div className="story-text">
              ...
              <p className="body-lg">
                Chaque fragrance Olivare est le fruit de centaines d&apos;heures de recherche et
            ...
            <div className="story-text">
              ...
              <p className="body-lg">
                Aujourd&apos;hui, Olivare Parfums compte plus de 15 000 clients satisfaits à travers
      ...
      <section className="section-padding py-20 lg:py-28">
        <div className="max-w-4xl mx-auto">
          <AnimatedSection className="text-center mb-12">
            <h2 className="heading-lg">Olivare en chiffres</h2>
          </AnimatedSection>
