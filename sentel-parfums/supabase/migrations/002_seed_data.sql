...
INSERT INTO reviews (id, product_id, name, city, rating, comment) VALUES
  (uuid_generate_v4(), '1', 'Amina B.', 'Casablanca', 5, 'Je suis bluffée par la similarité avec l''original. Santal Noir est exactement comme celui de Tom Ford à 5x le prix. Livraison rapide et emballage luxueux.'),
  ...
  (uuid_generate_v4(), '2', 'Laila M.', 'Marrakech', 5, 'La tenue est impressionnante — 10 heures facilement sur mes vêtements. Rose Velours est devenu mon signature scent. Merci Olivare !'),
  ...
  (uuid_generate_v4(), '3', 'Omar H.', 'Fès', 4, 'Très bon rapport qualité-prix. Oud Impérial est puissant et sophistiqué. J''apprécie particulièrement la transparence sur les notes olfactives.');
